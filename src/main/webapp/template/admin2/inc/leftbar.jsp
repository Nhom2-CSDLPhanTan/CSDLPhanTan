...
<div class="sidebar pe-4 pb-3">
	<nav class="navbar bg-secondary navbar-dark">
		<a href="<%=request.getContextPath()%>/public/index"
			...
			<h3 class="text-primary">
				<i class="fa fa-user-edit me-2"></i>Mua sắm
			</h3>
		</a>
		<%
	...
	out.print(request.getContextPath() + "/file/" + user.getUser_Avartar());%>"
		...
		<div class="navbar-nav w-100">
			<a href="<%=request.getContextPath()%>/client2/admin/index"
				...
				%>
				<a href="<%=request.getContextPath()%>/client2/admin/cat/index" id="danhmuc" class="nav-item nav-link">
					<i class="fa fa-th me-2"></i>Quản lý danh mục</a> 
				<%} %>
				<a href="<%=request.getContextPath()%>/client2/admin/products"
				class="nav-item nav-link" id="category"><i
				class="fa fa-keyboard me-2"></i>Quản lý sản phẩm</a> 
				<a
				href="<%=request.getContextPath()%>/client2/admin/user/index"
				class="nav-item nav-link" id="nguoidung"><i
				class="fa fa-table me-2"></i>Quản lý người dùng</a> 
				<a
				href="<%=request.getContextPath()%>/client2/admin/tintuc/index"
