					...
					<div class="bg-secondary rounded h-100 p-4"
						...
						<div style="margin-bottom: 40px;">
							...
							<button type="button" class="btn btn-success m-2"
								style="float: left;">
								<a href="<%=request.getContextPath()%>/client1/admin/cat/add" style="color: white;">Thêm danh mục</a>
						...
						<table class="table table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<td>
									<a
										href="<%=request.getContextPath()%>/client1/admin/cat/edit?id=<%=item.getCat_Id()%>"><button
												type="button" class="btn btn-info m-2">Sửa</button></a> 
												<a
										href="<%=request.getContextPath()%>/client1/admin/cat/del?id=<%=item.getCat_Id() %>"
