            ...
            <div class="container-fluid pt-4 px-4">
                <div class="col-sm-12 col-xl-6">
                    <div class="bg-secondary rounded h-100 p-4" style="margin-left: 150px; width: 850px;">
                        <h6 class="mb-4" style="font-size: 40px;" >Sửa hình ảnh</h6>
                        <form id="form" action="" method="post" enctype="multipart/form-data">
                        <%
                        	Picture itemEdit = null;
                        	if(request.getAttribute("itemEdit") != null){
                        		itemEdit = (Picture)request.getAttribute("itemEdit");
                        	}
                        ...
                        %>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <img style="margin-top:20px;width: 200px;height: 200px" alt="" src="<%=request.getContextPath() %>/file/<%=itemEdit.getUrl()%>">
                                </div>
                            </div>
  						<%
                        	}
