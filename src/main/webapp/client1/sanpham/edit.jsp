            ...
            <div class="container-fluid pt-4 px-4">
                <div class="col-sm-12 col-xl-6">
                    <div class="bg-secondary rounded h-100 p-4" style="margin-left: 150px; width: 850px;">
                        ...
                        <%
                        	Products itemEdit = null;
                        if(request.getAttribute("itemEdit") != null){
                        	itemEdit = (Products)request.getAttribute("itemEdit");
                        }
                        %>
                            <div class="row mb-3">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">Tên sản phẩm</label>
                                <div class="col-sm-10">
                                    <input type="text" required="required" value="<%if(itemEdit!=null) out.print(itemEdit.getName()); %>" name="tensp" class="form-control" id="inputEmail3">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" required="required" value="<%if(itemEdit!=null) out.print(itemEdit.getDetail()); %>" name="chitiet" class="form-control" id="inputEmail3">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input required="required"  value="<%if(itemEdit!=null) out.print(itemEdit.getPrice()); %>" type="text" name="giaban" class="form-control" id="inputEmail3">
                                </div>
                            </div>
                                    ...
                                    <select name="dm">
                                			...
                                			if(listCat!=null && listCat.size()>0){
                                   			for(Category item : listCat){
                                   				if(item.getCat_Id().equals(itemEdit.getC_id())){
                                   		%>
