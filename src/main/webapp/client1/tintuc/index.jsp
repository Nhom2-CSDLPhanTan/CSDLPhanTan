        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="col-sm-12 col-xl-6">
                    <div class="bg-secondary rounded h-100 p-4" style="margin-left: 150px; width: 1000px;">
                    
                        <h6 class="mb-4" style="font-size: 50px;">Quản lý tin tức</h6>
                        <div style="margin-bottom: 40px;">
                            <button type="button" class="btn btn-success m-2" style="float: left;"><a href="<%=request.getContextPath()%>/admin/tintuc/add" style="color: white;">Thêm tin tức</a></button>
                            <form class="d-none d-md-flex ms-4" >
                                <input style="margin-top: 4px; width: 340px; margin-left: 100px;" class="form-control bg-dark border-0" type="search" placeholder="Search">
                                <button type="button" class="btn btn-outline-primary m-2" style="margin-top: 3px;">Tìm kiếm</button>
                            </form>
                        </div>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row"></th>
                                    <td>Giảm giá sốc</td>
                                    <td>Giảm giá coffe đen đá mừng khai trương</td>
									<td> <img style="width: 50px; height: 50px" alt="" src="<%=request.getContextPath() %>/filetintuc/"> </td>
                                    <td>
                                        
                                        	<a href="<%=request.getContextPath()%>/admin/tintuc/edit?idtt="><button type="button" class="btn btn-info m-2">Sửa</button></a>
                                        
                                        <a href="<%=request.getContextPath()%>/admin/tintuc/del?idtt=" onclick="return confirm('Bạn có chắc muốn xóa không!');"><button type="button" class="btn btn-primary m-2" >Xóa</button></a>
                                    </td>
                                </tr>
