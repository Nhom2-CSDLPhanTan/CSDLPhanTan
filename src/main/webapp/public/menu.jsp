				...
				<div class="tm-menu-product-content col-lg-9 col-md-9">
					...
					<%
						...
						for(Products item : listProducts){
							Picture picture = productsDAO.getPictureByIdPro(item.getId());
					%>
					<div class="tm-product">
						<img src="<%=request.getContextPath()%>/file/<%=picture.getUrl() %>"
						...
						<div class="tm-product-text" style="margin: 10px;position: absolute; margin-left: 225px;">
							<h3 class="tm-product-title">
								<a href="<%=request.getContextPath()%>/client1/public/products/detail?id=<%=item.getId() %>" title="">Name: <%=item.getName() %></a>
							</h3>
