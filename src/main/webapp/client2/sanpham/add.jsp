                    ...
                    <div class="bg-secondary rounded h-100 p-4" style="margin-left: 150px; width: 850px;">
                        ...
                        <form id="form" action="" method="post">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" required="required" name="giagoc" class="form-control" id="inputEmail3">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" required="required" value="0" name="giamgia" class="form-control" id="inputEmail3">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select name="dm">
                                   <%!
                        public void  CreateChildMenu(String parentId, javax.servlet.jsp.JspWriter out, String str, int level){
            		        ...
            		        try{
            		            ...
            		            ResultSet rsl = stm.executeQuery("select * from danhmuc");
            		            try
            		            {
            		                while(rsl.next())
            		                {
            		                    
            		                    if(rsl.getString("id_danhmuccha").equals(parentId))
            		                    {
            		                        
            		                        idChildMenu.add(rsl.getString("id_danhmuc"));
            		                        nameChildMenu.add(rsl.getString("tendanhmuc"));
            		                    }
            		                }
            		                if(idChildMenu.size()>0)
            		                {
            		                	level++;
            		                	String str1 = str.repeat(level);
            		                	
            		                	
            		                    for(int i=0;i<idChildMenu.size();i++)
            		                    {
            		                    	out.println("<option>");    
                                            out.println(str1+nameChildMenu.get(i));
            		                       
            		                        CreateChildMenu(idChildMenu.get(i),out,str,level);
            		                    }
                        ...
                        public void  CreateMenu(javax.servlet.jsp.JspWriter out, String str, int level){
                            try{
                                ...
                                try
                                {
                                    ...
                                    while(rsl.next()) 
                                    {
                                        ...
                                        if(rsl.getString("id_danhmuccha").equals("0")) 
                                        {
                                            out.println("<option>");
                                            
                                            out.println(rsl.getString("tendanhmuc"));
                         					
                                            CreateChildMenu(rsl.getString("id_danhmuc"),out,str,level);
                                        }                  
                                    }
