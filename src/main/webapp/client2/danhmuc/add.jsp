            ...
            <div class="container-fluid pt-4 px-4">
                <div class="col-sm-12 col-xl-6">
                    <div class="bg-secondary rounded h-100 p-4" style="margin-left: 150px; width: 850px;">
                        <h6 class="mb-4" style="font-size: 40px;">Thêm danh mục</h6>
                        <form id="form" action="" method="post">
                        	<div class="row mb-3">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">Mã danh mục</label>
                                <div class="col-sm-10">
                                    <input type="text" name="madm" class="form-control" required="required" id="inputEmail3">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="tendm" class="form-control" required="required" id="inputEmail3">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="mota" class="form-control" required="required" id="inputEmail3">
                                </div>
                            </div>
