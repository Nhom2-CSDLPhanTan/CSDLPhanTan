            ...
            <div class="container-fluid pt-4 px-4">
                <div class="col-sm-12 col-xl-6">
                    <div class="bg-secondary rounded h-100 p-4" style="margin-left: 150px; width: 850px;">
                        <h6 class="mb-4" style="font-size: 40px;">Sửa tin tức</h6>
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="row mb-3">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">Tên tin tức</label>
                                <div class="col-sm-10">
                                    <input value="Giảm giá sốc" type="text" name="tentt" class="form-control" id="inputEmail3">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">Chi tiết</label>
                                <div class="col-sm-10">
                                    <input value="" type="text" name="chitiet" class="form-control" id="inputEmail3" multiple="multiple">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="file" name="ha" class="form-control" id="inputEmail3">
                                        	...
                                        	<br>
                                        	<img width="200px" height="200px" alt="" src="<%=request.getContextPath() %>/filetintuc/" alt="Ảnh">
