			...
			<div class="row">
				<div class="tm-top-header-inner">
					<div class="tm-logo-container">
						...
						<h1 class="tm-site-name tm-handwriting-font">MilkTea House</h1>
					</div>
					...
					<nav class="tm-nav">
						<ul>
							<li><a href="<%=request.getContextPath()%>/client2/public/index"
								id="home">Home</a></li>

							<li><a href="<%=request.getContextPath()%>/client2/public/products"
								id="menu">Menu</a></li>
							<li><a href="<%=request.getContextPath()%>/client2/public/contact"
								id="contact">Contact</a></li>
							<li><a href="<%=request.getContextPath()%>/client2/public/cart"
								id="info">Cart</a></li>
							...
							if (userLogin != null) {
							%>
							<li><a href="<%=request.getContextPath()%>/client2/admin/index" id="login"><%=userLogin.getUser_Name()%></a></li>
							<li><a href="<%=request.getContextPath()%>/logoutc2" id="logout">Logout</a></li>
							<%
							} else {
							%>
							<li><a href="<%=request.getContextPath()%>/loginc2" id="login">Login</a></li>
							<%
							}
							%>
	...
	<section class="tm-welcome-section">
		<div class="container tm-position-relative">
			...
			<div class="row tm-welcome-content">
				...
				<h2 class="gold-text tm-welcome-header-2">MilkTea House</h2>
			</div>
