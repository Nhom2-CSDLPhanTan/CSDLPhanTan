                ...
                <div class="col-sm-12 col-xl-6">
                    <div class="bg-secondary rounded h-100 p-4" style="margin-left: 150px; width: 1800px;">
                        ...
                        <div style="margin-bottom: 40px;">
                            <button type="button" class="btn btn-success m-2" style="float: left;"> <a href="<%=request.getContextPath()%>/admin/sanpham/add" style="color: white;">Thêm sản phẩm</a> </button>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>ABCDF</td>
                                            <td>Coffe đen</td>
                                            <td> <a href="<%=request.getContextPath()%>/admin/sanpham/hinhanhsp?idsp=" style="color: #0075ff">Quản lý hình ảnh</a></td>
                                            <td>20000</td>
                                            <td>
                                            
                                                <a href="<%=request.getContextPath()%>/admin/sanpham/edit?idsp="><button type="button" class="btn btn-info m-2">Sửa</button></a>
                                               
                                                <a href="<%=request.getContextPath()%>/admin/sanpham/del?idsp="><button type="button" class="btn btn-primary m-2" onclick="return confirm('Bạn có chắc muốn xóa không');">Xóa</button></a>
                                            </td>
                                        </tr>
