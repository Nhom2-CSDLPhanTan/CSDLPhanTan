            ...
            <div class="container-fluid pt-4 px-4">
                <div class="col-sm-12 col-xl-6">
                    <div class="bg-secondary rounded h-100 p-4" style="margin-left: 150px; width: 850px;">
                        <h6 class="mb-4" style="font-size: 40px;">Sửa danh mục</h6>
                        <%
                        	Category itemEdit = (Category) request.getAttribute("itemEdit");
                        %>
                        <form id="form" action="" method="post">
                            <div class="row mb-3">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">Tên danh mục</label>
                                <div class="col-sm-10">
                                    <input  name="tendm" type="text" required="required" class="form-control" id="inputEmail3" value="<%=itemEdit.getCat_Name()%>">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input  name="mota" type="text" required="required" class="form-control" id="inputEmail3" value="<%=itemEdit.getCat_Detail()%>">
                                </div>
                            </div>
