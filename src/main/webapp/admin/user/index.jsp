...
<body>
			...
			<div class="container-fluid pt-4 px-4">
				<div class="col-sm-12 col-xl-6">
					<div class="bg-secondary rounded h-100 p-4"
						...
						%>
						<a href="<%=request.getContextPath()%>/admin/user/update">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										...
										%> <a
										href="<%=request.getContextPath()%>/admin/user/edit?id=<%=item.getUser_ID()%>"><button
 ...
 %> <a href="<%=request.getContextPath()%>/admin/user/del?iduser=<%=item.getUser_ID()%>"
