...
public class LoginForgetPassAdminClient2Controller extends HttpServlet {
	...
	public LoginForgetPassAdminClient2Controller() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher rd = request.getRequestDispatcher("/client2/login/loginforget.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (item != null) {
			String forgetPass = LoginForgetPassAdminClient2Controller.randomAlphaNumeric(8);
