...
@MultipartConfig
public class EditUserAdminClient2Controller extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private PersonDAO personDAO;

	public EditUserAdminClient2Controller() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher rd = request.getRequestDispatcher("/client2/user/edit.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(personDAO.editItem(itemEdit) > 0) {	
			...
			response.sendRedirect(request.getContextPath() + "/client2/admin/user/index?msg=2");
			return;
		}
