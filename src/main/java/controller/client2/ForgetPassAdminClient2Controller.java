...
public class ForgetPassAdminClient2Controller extends HttpServlet {
	private static final long serialVersionUID = 1L;
    private PersonDAO personDAO;
    public ForgetPassAdminClient2Controller() {
        super();
        personDAO = new PersonDAO();
    }

	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		RequestDispatcher rd = request.getRequestDispatcher("/client2/login/forget.jsp");
...
request.setCharacterEncoding("utf-8");
		...
		if(item != null) {
	        ...
	        try {
		        ...
		        response.sendRedirect(request.getContextPath() + "/client2/admin/forget/login");
